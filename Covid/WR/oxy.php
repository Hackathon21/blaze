...
<html lang="en">
  ...
  <body onload="fetch()">
    ...
    <div class="mb-6">
    <br><br>
        <h1 align='center' >Available Oxygen Cylinders</h1>
        <br><br>
    </div>
    ...
    if ($err) {
        ...
        ?>
                <tr>
                <td><?php echo $data[0]['Oxygeninfo'][0]['Verified at'] ?></td>
                <td><?php echo $data[0]['Oxygeninfo'][0]['Location'] ?></td>
                <td><?php echo $data[0]['Oxygeninfo'][0]['Contact'] ?></td>
                </tr>
           <?php
        }
